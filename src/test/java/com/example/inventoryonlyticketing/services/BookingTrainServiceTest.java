...
//    final var departureStation = new Station("LW01", "London Waterloo");
//    final var arrivalStation = new Station("PGDN01", "Paris Garde du Nord");
